                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="m-5">
                                    <div class="card-body">
                                        ...
                                        <h2 class="text-center mb-4">{{ isEdit ? 'Editar Usuario' : 'Registrar Usuario'
                                            }}</h2>
                                        ...
                                        <form class="user" @submit.prevent="registerEdit">
                                            ...
                                            <div class="form-group">
                                                <input type="text" v-model="fullName" id="fullName"
                                                    class="form-control form-control-user" placeholder="Nombre completo"
                                                    required />
                                            </div>
                                            ...
                                            <div v-if="isEdit">
                                                <div class="form-group">
                                                    <input type="text" v-model="userRole" id="userRole"
                                                        class="form-control form-control-user" placeholder="Cliente"
                                                        :readonly="isEdit" />
                                                </div>
                                            </div>
                                            ...
                                            <div v-if="!isEdit">
                                                ...
                                                <div class="form-group">
                                                    <input type="password" v-model="confirmPassword"
                                                        id="confirmPassword" class="form-control form-control-user"
